...
Student engagement is a crucial determinant of academic success, influenced by a range of emotional, cognitive, and behavioral factors that shape how students interact with educational tasks [@kahu2018student] [@wang2014staying]. Emotional aspects, such as feelings and interests, are known to drive motivation [@trautwein2015using], while cognitive components, including self-perceived competence and task difficulty, play a significant role in academic persistence and performance [@mac1991explaining] [@akbari2020students]. Additionally, external interventions like personalized email interventions have been increasingly utilized to influence student behaviors and attitudes toward learning tasks [@chevalier2014making] [@goes2016incentive]. This study analyses how various emotional, cognitive, and motivational predictors collectively influence changes in student effort in response to email-based interventions.

Building upon the existing literature on student engagement and targeted interventions [@wang2014staying], this study delves into the complex interplay of emotional, cognitive, and motivational predictors that influence changes in student effort following an email-based academic intervention. Through the examination of a sampled subset of over 600 records of student engagement data, this research analyzes variables such as changes in feeling states, perceived cognitive competence, task difficulty perception, intrinsic interest, and the type of email intervention received, adopting a Bayesian multiple linear regression model to explore these relationships. The modeling approach, implemented using the `rstanarm` package in R [@rstanarm], enables a valuable evaluation of the conditional relationships between these predictors and variations in student effort. While prior studies, such as @mac1991explaining and @chevalier2014making, have investigated these factors individually, their combined effects within the context of a targeted intervention remain under-explored. This study not only quantifies the influence of each factor but also offers nuanced understanding on how these dimensions interact to shape behavioral responses, providing a statistically rigorous framework for understanding student engagement strategies.

Our findings emphasizes a deliberate focus on leveraging feelings, cognitive, and motivational dimensions to influence changes in student effort following email-based interventions. The analysis emphasizes that positive shifts in emotional states, such as increased interest and affect, played an important role in fostering sustained engagement. Cognitive competence, reflecting students' confidence in their abilities, is similarly instrumental in encouraging perseverance. On the other hand, perceived difficulty showed a nuanced impact, suggesting that while challenges can motivate effort, excessive difficulty may hinder engagement. The inclusion of engaging email types further amplified the intervention's effectiveness, demonstrating that strategic communication can significantly enhance student motivation and academic effort.

The significance of these insights extends beyond understanding individual predictors, providing practical implications for designing interventions that enhance academic engagement and motivation. These findings provide a foundation for developing evidence-based strategies that leverage emotional and cognitive support alongside personalized communication, offering valuable and cost-effective solutions for educational contexts. Furthermore, this study contributes to the broader academic discourse on how targeted interventions can address systemic challenges in student engagement, enriching ongoing discussions in the field of educational psychology and behavioral science, as @pajares2001toward and @winne2010psychology explored. 
