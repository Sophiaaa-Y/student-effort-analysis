...
2. *Is there a repository that links to any or all papers or systems that use the dataset? If so, please provide a link or other access point.*
	- The dataset is associated with research conducted by the University of Toronto’s Department of Statistical Sciences. Relevant analyses, code, and findings are documented in the GitHub repository: [Nudge Data Repository](https://github.com/ntaback/nudgedata).
